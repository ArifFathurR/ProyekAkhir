        ...
        <main className="pt-28 px-4">
          <div className="w-full">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">Kelola data tim perusahaan</p>
            </div>
                      ...
                      <tr>
                        <td colSpan="3" className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-sm font-medium text-gray-900 mb-1">Tidak ada data tim</h3>
                            <p className="text-sm text-gray-500">
                              {search ? 'Tidak ditemukan tim yang sesuai dengan pencarian.' : 'Belum ada tim yang terdaftar.'}
                            </p>
                          </div>
                        </td>
                      </tr>
